...
=======
                case 0:
                    Salir();
                    break;
>>>>>>> 90c83918e972f8ba992d1c352ed1c2693aad72c9
                default:
...
>>>>>>> 90c83918e972f8ba992d1c352ed1c2693aad72c9
    ...
    private static void Explicacion_byte() {
        ...
        do {
            ...
            System.out.println("para fines de aplicación.                                              ");
            System.out.println("-----------------------------------------------------------------------");
            System.out.println("Ingrese la opción 1 para regresar al menu: ");
            opcion = scanner.nextInt();
            scanner.nextLine();
            ...
            switch (opcion) {
                case 1:
                    System.out.println("----------------------------------------------------------------");
                    System.out.println(" redirigiendo al menú datos primitivos                          ");
                    System.out.println("----------------------------------------------------------------");
                    break;
                default:
                    System.out.println("Ingrese opcion valida");
    ...
    private static void Condicionalesif_else_ifelse() {
        int opcion=0;
        do {
            System.out.println("-------------------------------------------------------------");
            System.out.println("            Condicionales IF - ELSE IF - ELSE                ");
